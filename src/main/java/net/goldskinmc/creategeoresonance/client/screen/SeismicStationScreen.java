...
public class SeismicStationScreen extends AbstractContainerScreen<SeismicStationMenu> {
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        graphics.drawString(font, Component.translatable("block.creategeoresonance.seismic_station.ink"), 26, 40, 0xD0D0D0, false);
        graphics.drawString(font, Component.translatable("block.creategeoresonance.seismic_station.output"), 53, 40, 0xD0D0D0, false);
